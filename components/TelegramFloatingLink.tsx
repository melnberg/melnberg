// 우측 하단 떠 있는 텔레그램 채널 구독 링크.
// FeedbackWidget(=bottom-5 right-5) 위쪽에 적당한 간격 두고 배치.
...
export default function TelegramFloatingLink() {
  return (
    ...
    >
      ...
      <span className="text-[12px] font-bold tracking-wide whitespace-nowrap">실시간 피드받기</span>
    </a>
  );
}
