      ...
      <section>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-[12px] border-collapse">
            <thead>
              <tr className="bg-bg/60 border-y border-navy text-muted">
                <th className="py-0.5 px-2 w-10 text-center">
                  <input
                    type="checkbox"
                ...
                <th className="py-0.5 px-2 font-semibold text-center w-24 whitespace-nowrap">조합원</th>
                <th className="py-0.5 px-2 font-semibold text-left">닉네임</th>
                <th className="py-0.5 px-2 font-semibold text-left w-32">네이버 ID</th>
                <th className="py-0.5 px-2 font-semibold text-left w-48">이메일</th>
                <th className="py-0.5 px-2 font-semibold text-left w-[220px]">SNS 링크</th>
                <th className="py-0.5 px-2 font-semibold text-center w-24">만료일</th>
                <th className="py-0.5 px-2 font-semibold text-center w-24">가입일</th>
              </tr>
            </thead>
            <tbody>
              {filtered.map((p) => {
                ...
                return (
                  <tr key={p.id} className={`border-b border-border hover:bg-bg/40 ${checked ? 'bg-[#f5f9ff]' : ''}`}>
                    ...
                    <td className="py-0.5 px-2 text-center whitespace-nowrap">
                      <span className={`inline-block text-[10px] font-bold px-1.5 py-0.5 whitespace-nowrap ${isActive ? 'bg-cyan text-navy' : 'bg-navy-soft text-navy/60'}`}>
                    ...
                    <td className="py-0.5 px-2 text-[12px] text-text">
                      {p.naver_id ?? <span className="text-muted">—</span>}
                    </td>
                    <td className="py-0.5 px-2 text-[12px] text-text truncate max-w-[200px]" title={(p as { email?: string | null }).email ?? ''}>
                      {(p as { email?: string | null }).email ?? <span className="text-muted">—</span>}
                    </td>
                    <td className="py-0.5 px-2 text-[11px]">
                      {p.link_url ? (
                    ...
                    <td className="py-0.5 px-2 text-center text-muted tabular-nums">
