      ...
      <section>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-[12px] border-collapse">
            <thead>
              <tr className="bg-bg/60 border-y border-navy text-muted">
                <th className="py-0 px-2 w-10 text-center">
                  <input
                    type="checkbox"
                ...
                <th className="py-0 px-2 font-semibold text-center w-24 whitespace-nowrap">조합원</th>
              ...
              {filtered.map((p) => {
                ...
                return (
                  <tr key={p.id} className={`border-b border-border hover:bg-bg/40 ${checked ? 'bg-[#f5f9ff]' : ''}`}>
                    ...
                    <td className="py-0 px-2 text-center text-muted tabular-nums">
