      ...
      {open ? (
        ...
        <>
          ...
          <button
            ...
            className="w-9 h-9 rounded-full bg-white border border-border text-navy hover:border-navy hover:bg-navy-soft flex items-center justify-center transition-colors flex-shrink-0"
          >
