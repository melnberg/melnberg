  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-2 left-2 z-30 w-9 h-9 rounded-full bg-white border border-border text-navy hover:border-navy hover:bg-navy-soft flex items-center justify-center p-0"
      >
