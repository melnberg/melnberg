...
export type MlbgAwardKind = 'apt_post' | 'apt_comment' | 'community_post' | 'community_comment' | 'hotdeal_post' | 'hotdeal_comment' | 'factory_comment' | 'emart_comment' | 'auction_comment' | 'restaurant_comment' | 'kids_comment' | 'store_comment';
