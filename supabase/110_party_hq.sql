...
insert into public.factory_locations (brand, name, address, lat, lng, occupy_price, daily_income) values
  ('party_dem',   '더불어민주당 본부', '서울 영등포구 국회대로68길 7',                 37.5340, 126.9170, 50, 3),
  ('party_ppl',   '국민의힘 본부',     '서울 영등포구 국회대로74길 12 (남중빌딩)',     37.5325, 126.9165, 50, 3),
  ('party_jhs',   '조국혁신당 본부',   '서울 영등포구 국회대로70길 15-1 (극동VIP빌딩)', 37.5335, 126.9175, 50, 3),
  ('party_ref',   '개혁신당 본부',     '서울 영등포구 당산로41길 11, 206-207호 (당산동)', 37.5347, 126.9020, 50, 3),
  ('party_jin',   '진보당 본부',       '서울 영등포구 국회대로 인근',                   37.5320, 126.9180, 50, 3),
  ('party_basic', '기본소득당 본부',   '서울 영등포구 국회대로70길 15-1, 302호',        37.5336, 126.9176, 50, 3),
  ('party_sd',    '사회민주당 본부',   '서울 영등포구 국회대로 인근',                   37.5328, 126.9172, 50, 3)
