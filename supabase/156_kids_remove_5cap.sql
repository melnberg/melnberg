-- ──────────────────────────────────────────────
-- 156: 육아 장소 핀 1인 5개 제한 제거
-- 149 의 register_kids_pin 에서 v_count >= 5 체크만 빼고 나머지 유지
-- ──────────────────────────────────────────────

drop function if exists public.register_kids_pin(text, text, text, numeric, numeric, text, text, text);
