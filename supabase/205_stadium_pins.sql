...
-- ──────────────────────────────────────────────
-- 시드 데이터 — admin(melnberg_rsch@naver.com) 명의. 좌표는 카카오 키워드 검색 첫 결과 기준.
-- 잠실은 종합운동장 1개로 통일 (야구장·실내체육관 별도 핀 안 둠 — 단지 안에 함께).
-- ──────────────────────────────────────────────
...
from (
  values
    ('잠실종합운동장', '서울 최대 종합스포츠 단지. 1988 올림픽 주경기장 + 야구장 + 실내체육관 + 수영장 + 학생체육관.', '국제경기·콘서트·야구·실내스포츠', 37.514591::numeric, 127.073025::numeric, '서울 송파구 올림픽로 25', '잠실동'),
    ('목동운동장', '양천구 종합 스포츠. 야구장·주경기장·아이스링크 묶음.', '아마야구·축구·아이스링크', 37.530729::numeric, 126.882099::numeric, '서울 양천구 안양천로 939', '목동'),
    ('목동야구장', '키움 히어로즈 옛 홈구장. 현재 아마·고교야구 메인.', '아마야구·고교야구', 37.530847::numeric, 126.880908::numeric, '서울 양천구 안양천로 939', '목동'),
    ('서울월드컵경기장', '2002 한일월드컵 개최지. FC서울 홈. 6.6만석.', '축구 (K리그·국가대표)', 37.568250::numeric, 126.897244::numeric, '서울 마포구 월드컵로 240', '성산동'),
    ('고척스카이돔', '국내 유일 돔구장. 키움 히어로즈 홈. 1.6만석.', '프로야구·콘서트', 37.498212::numeric, 126.867089::numeric, '서울 구로구 경인로 430', '고척동'),
    ('장충체육관', '국내 1호 실내체육관. 도드람 V리그 우리카드 홈.', '배구·격투기·콘서트', 37.558178::numeric, 127.006809::numeric, '서울 중구 동호로 241', '장충동'),
    ('효창운동장', '용산구 축구 전용. 동대문운동장 철거 후 아마축구 메인.', '축구·육상', 37.543529::numeric, 126.961210::numeric, '서울 용산구 효창원로 177-15', '효창동'),
    ('KSPO돔 (올림픽체조경기장)', '올림픽공원 메인 실내. 1.5만석. 콘서트·실내경기.', '콘서트·실내경기', 37.519261::numeric, 127.127400::numeric, '서울 송파구 올림픽로 424', '방이동'),
    ('SK올림픽핸드볼경기장', '올림픽공원 핸드볼·배구·E스포츠.', '핸드볼·E스포츠·콘서트', 37.516869::numeric, 127.127073::numeric, '서울 송파구 올림픽로 424', '방이동'),
    ('마들스타디움', '노원구 종합 운동장. 육상트랙 + 축구장.', '육상·축구·생활체육', 37.643953::numeric, 127.057551::numeric, '서울 노원구 동일로 1748', '상계동')
