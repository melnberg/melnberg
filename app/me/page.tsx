      ...
      <section className="py-12">
        <div className="max-w-[680px] mx-auto px-6">
          ...
          <div className="mt-8">
            ...
            <div className="mt-3 flex items-center justify-between px-4 py-3 border border-border">
              <div>
                <div className="text-[12px] font-bold text-navy">mlbg 적립 기준</div>
                <p className="text-[11px] text-muted mt-0.5">단지·커뮤니티·시설 활동에 따라 자동 적립. 누적 점수: <b className="text-text">{score}</b></p>
              </div>
              <Link href="/me/rewards" className="px-3 py-1.5 border border-navy bg-white text-navy text-[12px] font-bold no-underline hover:bg-navy hover:text-white whitespace-nowrap">
                보상 정책 보기 →
              </Link>
            </div>
          </div>
