...
export async function POST(req: NextRequest) {
  try {
    ...
    const styleRules = [
      ...
      '- 마크다운 일체 금지: # ## ### 헤더, ** 굵게, * 이탤릭, ` 코드, --- 구분선, | 표, > 인용 모두 사용 금지. 특히 ** 별표 두 개로 굵게 표시 절대 금지.',
      ...
      '',
      '구조 표현 규칙:',
      '- 제목·소제목·문단 구분이 필요한 경우 숫자 번호로 계층 표현.',
      '  · 대제목: "1. 제목내용", "2. 제목내용", "3. 제목내용"',
      '  · 소제목: "1.1 소제목", "1.2 소제목", "2.1 소제목"',
      '  · 더 깊은 레벨: "1.1.1 ..."',
      '- 번호 뒤 제목은 평문으로만 작성. ** 별표 등 강조 기호 절대 붙이지 말 것 (렌더러가 자동으로 굵게 표시함).',
      '- 본문 항목 나열은 "- " 대시 사용.',
      '',
      '절대 금지 표현 (자료 없음 안내 문구):',
      '- "자료가 부족합니다", "답변드리기 어렵습니다", "확인이 어렵습니다", "자료에 없습니다", "더 자세한 정보는...", "정보가 제한적입니다", "추가 정보가 필요합니다" 등 사과·안내 일체.',
