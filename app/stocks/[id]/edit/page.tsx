...
export default async function EditStocksPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    <Layout current="stocks">
      ...
      <section className="py-12">
        <div className="max-w-[760px] mx-auto px-6">
          ...
          <PostForm initial={{ id: post.id, title: post.title, content: post.content }} category="stocks" redirectBase="/stocks" />
        </div>
      </section>
    </Layout>
  );
